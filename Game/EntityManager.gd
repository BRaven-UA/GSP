...
const DEF_CONS_COST: int = 2 # стоимость виртуальных расходников
...
const ENTITIES := [
	...
	{NAME:"Новая способность", CLASS:CLASSES.ABILITY}, # заглушка для выбора перка
		...
		{NAME:"Вундеркинд", CLASS:CLASSES.ABILITY, DESCRIPTION:"Позволяет получать больше опыта", GROUP:GROUPS.PERK},
		{NAME:"Книга Дейла Карнеги", CLASS:CLASSES.ITEM, DESCRIPTION:"Как завоёвывать друзей и оказывать влияние на людей", COST:100, ACTIVE:false, KNOWLEDGE:"Красноречие"},
		{NAME:"Красноречие", CLASS:CLASSES.ABILITY, DESCRIPTION:"Дает преимущества при общении с людьми", GROUP:GROUPS.PERK}]
