...
enum {TIP_START, TIP_NOTEBOOK, TIP_NOTE, TIP_META, TIP_TIME, TIP_ACTIVE, TIP_WEAPON, TIP_RESTORE, TIP_LOAD, TIP_TRADE, TIP_TRACKING, TIP_STUDY, TIP_LEVEL, TIP_DEATH}
const TIPS := {
	...
	TIP_STUDY:"В игре есть предметы, которые содержат в себе определенные знания. Чтобы начать изучение нужно активировать предмет. После каждого события прогресс изучения будет увеличиваться",
